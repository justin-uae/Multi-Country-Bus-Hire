...
export const countryData = {
  ...
  pl: {
    ...
    aboutUs: {
      badge: "About Us",
      description:
        "At Poland Buses, we are proud to be one of Poland's leading providers of reliable, comfortable, and affordable group transportation. From Warsaw to Krakow, Wroclaw to Gdansk, we make travel simple with our modern fleet, professional drivers, and commitment to exceptional service throughout Poland.",
      image: "/images/abtus.png",
      features: [
        {
        ...
        },
        {
          ...
          description:
            "Every Poland Buses driver is fully licensed, background-checked, and trained to provide safe, punctual, and friendly service — whether for short city transfers or long-distance journeys across Poland.",
        },
        {
          title: "Tailored Travel Solutions Poland",
          description:
            "We handle corporate events, school trips, wedding transport, airport transfers, and private tours across Poland. Whatever your group size or schedule, we'll plan a journey that fits your needs perfectly.",
        },
        {
          title: "Transparent Pricing Poland",
          description:
            "Our quotes are all-inclusive with no hidden fees, giving you peace of mind and total clarity on costs before you travel anywhere in Poland.",
        },
      ],
    },
